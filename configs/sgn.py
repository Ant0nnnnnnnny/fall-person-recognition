...
def sgn_config(parser):
    ...
    # parser.add_argument('--pretrained_weight',type = str,default = 'checkpoints/sgn/c0833seg30.pth') #ntu pretrained weight.
    parser.add_argument('--pretrained_weight',type = str,default = '') #ntu pretrained weight.
