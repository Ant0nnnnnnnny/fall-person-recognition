...
## 根据d填充k，根据k来自动填充p，dilation表示卷积核膨胀操作
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5):  # ch_in, ch_out, shortcut, groups, expansion
        ...
        self.cv1 = Conv(c1, c_, 1, 1)# 1*1 convolution
        self.cv2 = Conv(c_, c2, 3, 1, g=g)# 3*3 convolution
        self.add = shortcut and c1 == c2

    def forward(self, x):
        ## 根据self.add确定是否需要进行短接x
